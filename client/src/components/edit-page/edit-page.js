...
export default class EditPage extends Component {
  constructor ({ editNote }) {
    ...
    this.state = { title, text1, text2, text3, text4, text5, text6, date }
  }
  ...
  submit = async event => {
    ...
    setAlert(true, 'Заявление было отредактировано', 'info')
  }
              ...
              <div className="form-group">
                ...
                <div className="input-group mb-3">
                  <div className="custom-file">
                    ...
                    <label className="custom-file-label" for="inputGroupFile02">Выберете файл</label>
                  </div>
